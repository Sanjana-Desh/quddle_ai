...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _loadExchangeRate() async {
    ...
    if (result['success'] && mounted) {
      setState(() {
        _exchangeRate = double.tryParse(result['rate'].toString()) ?? 3.67;
      });
    }
  }
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
          ...
          children: [
            ...
            TextField(
              ...
              onChanged: (value) {
                ...
                final dollars = double.tryParse(value);
                if (dollars != null) {
                  // You could update a state variable here to show conversion
                }
              },
            ),
            const SizedBox(height: 8),
            ValueListenableBuilder(
              valueListenable: dollarController,
              builder: (context, value, child) {
                final dollars = double.tryParse(value.text);
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              final dollars = double.tryParse(dollarController.text);
              if (dollars == null || dollars <= 0) {
              ...
              final result = await WalletService.addMoney(dollars);
