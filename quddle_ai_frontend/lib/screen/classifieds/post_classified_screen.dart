...
class _PostClassifiedScreenState extends State<PostClassifiedScreen> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {'label': 'Mobile Phones', 'icon': Icons.phone_android},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Post Classified Ad', style: TextStyle(color: Colors.black)),
              ...
              child: Center(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Icon(Icons.account_balance_wallet, size: 16, color: MyColors.primary),
